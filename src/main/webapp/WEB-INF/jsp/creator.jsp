...
<main>
    <div class="container-fluid vh-100">
        <div class="w-10 border border-light text-center" id="position">
        ...
        <div class="w-90" id="parrentBlock"></div>
    </div>
</main>
...
<script>
    $(function() {
        ...
        $(document).on('click','.dragMenuClone', function() {
            $(this).droppable({
                activeClass: "activeDrop",
                hoverClass: "hoverDrop",
                //accept: ".element",
